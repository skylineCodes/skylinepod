...
const DesktopDashboard = () => {
  const newEpisodes = playlists?.filter((item: any, index: number) => item?.new === true);
  const papayaEpisodes = playlists?.filter(
    (item: any, index: number) => item?.artistName === 'From Where We Stand'
  );
  const chasingLifeEpisodes = playlists?.filter(
                ...
                <Flex gap={'15px'} mt={5}>
                  <Box position={'relative'} width={350} height={250}>
                    <Image
                      ...
                      src={`${newEpisodes[0]?.podcastThumb}`}
                      alt={`${newEpisodes[0]?.title}`}
                      width={350}
                      height={250}
                    />
                    <Box
                  ...
                  <Box position={'relative'} width={280} height={150}>
                    <Image
                      ...
                      src={`${papayaEpisodes[0]?.podcastThumb}`}
                      alt={`${papayaEpisodes[0]?.title}`}
                      width={280}
                      height={150}
                    />
                    <Box
                  ...
                  <Box position={'relative'} width={280} height={150}>
                    <Image
                      ...
                      src={`${chasingLifeEpisodes[0]?.podcastThumb}`}
                      alt={`${chasingLifeEpisodes[0]?.title}`}
                      width={280}
                      height={150}
                    />
                    <Box
                    ...
                    <Box width={'100%'} pl={'10px'} pr={'10px'} mt={5}>
                      ...
                      <Text
                        ...
                        noOfLines={1}
                      >
                        {`${chasingLifeEpisodes[0]?.artistName}`}
                      </Text>
                    </Box>
                  </Box>
                </Flex>
